    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-pink-50 to-blue-50">
      ...
      <section className="container mx-auto px-6 py-20 text-center">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-6xl font-bold bg-gradient-to-r from-orange-600 via-pink-600 to-blue-600 bg-clip-text text-transparent mb-4">A Madan</h2>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              <div className="bg-white/90 backdrop-blur-sm p-6 rounded-xl shadow-lg border-l-8 border-orange-500 hover:shadow-xl transition-shadow">
                ...
                <p className="text-gray-600">CGPA: 6.0</p>
              </div>
              <div className="bg-white/90 backdrop-blur-sm p-6 rounded-xl shadow-lg border-l-8 border-pink-500 hover:shadow-xl transition-shadow">
                <h4 className="text-xl font-bold text-pink-700 mb-2">Vision PU College, Bangalore</h4>
                <p className="text-gray-700 font-medium mb-1">PCMB</p>
                <p className="text-gray-600">Percentage: 88%</p>
              </div>
              <div className="bg-white/90 backdrop-blur-sm p-6 rounded-xl shadow-lg border-l-8 border-blue-500 hover:shadow-xl transition-shadow">
                <h4 className="text-xl font-bold text-blue-700 mb-2">SFS High School, Koppal</h4>
                <p className="text-gray-700 font-medium mb-1">State Board</p>
                <p className="text-gray-600">Percentage: 94.24%</p>
              </div>
            </div>
            <div className="mt-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <a href="mailto:madanayyanavara@gmail.com" className="flex items-center justify-center space-x-3 bg-gradient-to-br from-orange-100 to-orange-200 p-6 rounded-xl hover:from-orange-200 hover:to-orange-300 transition-all shadow-lg hover:shadow-xl transform hover:scale-105">
                ...
                <div className="text-left">
                  ...
                  <p className="text-orange-900 font-medium">madanayyanavara@gmail.com</p>
                </div>
              </a>
              <a href="tel:+919353480249" className="flex items-center justify-center space-x-3 bg-gradient-to-br from-pink-100 to-pink-200 p-6 rounded-xl hover:from-pink-200 hover:to-pink-300 transition-all shadow-lg hover:shadow-xl transform hover:scale-105">
                ...
                <div className="text-left">
                  ...
                  <p className="text-pink-900 font-medium">+91-9353480249</p>
                </div>
              </a>
              <a href="https://linkedin.com/in/a-madan-883305256" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center space-x-3 bg-gradient-to-br from-blue-100 to-blue-200 p-6 rounded-xl hover:from-blue-200 hover:to-blue-300 transition-all shadow-lg hover:shadow-xl transform hover:scale-105">
                <Linkedin className="text-blue-600" size={24} />
                <div className="text-left">
                  <p className="text-sm text-blue-700 font-semibold">LinkedIn</p>
                  <p className="text-blue-900 font-medium">a-madan-883305256</p>
                </div>
              </a>
              <a href="https://github.com/MadanAyyanavara" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center space-x-3 bg-gradient-to-br from-teal-100 to-teal-200 p-6 rounded-xl hover:from-teal-200 hover:to-teal-300 transition-all shadow-lg hover:shadow-xl transform hover:scale-105">
                <Github className="text-teal-600" size={24} />
                <div className="text-left">
                  <p className="text-sm text-teal-700 font-semibold">GitHub</p>
                  <p className="text-teal-900 font-medium">MadanAyyanavara</p>
                </div>
              </a>
            </div>
          </div>
      ...
      <footer className="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 text-white py-8">
        <div className="container mx-auto px-6 text-center">
          <p className="text-gray-300">© 2025 A Madan. All rights reserved.</p>
